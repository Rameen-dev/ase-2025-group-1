...
interface CharityDonationHistoryModalProps {
    ...
    onViewRequest: (request: DonationRequest) => void;
}
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[60]">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-3xl max-h-[80vh] flex flex-col">
                ...
                {/* Content */}
                <div className="flex-1overflow-y-auto overflow-x-hidden max-h-[60vh]">
                        ...
                        <table className="w-full text-sm table-fixed">
                            ...
                            <tbody>
                                {historyRequests.map((r) => {
                                    ...
                                    const rowBg = isApproved ? "bg-green-50" : "bg-red-50";

                                    const statusClasses = isApproved ? "text-green-700 font-semibold" : "text-red-600 font-semibold";

                                    return (
                                        <tr key={r.donation_request_id} className={`border-t ${rowBg}`}>
                                            ...
                                            <td className="p-3 text-center" >
                                                <button className="text-center px-3 py-2 rounded-md border border-blue-300 text-blue-600 hover:bg-blue-50"
